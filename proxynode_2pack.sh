...
unzip Linux.zip
sleep 3
sudo mv /root/Linux/bin/prx/prxd /root/Linux/bin/prx/prx-cli /usr/local/bin
...
echo "addnode=[${MNIP1}]" >> /home/proxynode2/.proxynode/prx.conf
if [[ $NULLREC = "y" ]] ; then
...
echo -e "${YELLOW}For mn1: \"prx-cli - masternode status\""${CLEAR}
