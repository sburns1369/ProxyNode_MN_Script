...
sudo adduser --system --home /home/proxynode0 proxynode0
MN1=0
fi
echo
echo
...
rm -rf /root/prx
if [ ! -f /home/proxynode0/.proxynode/prx.conf ]; then
echo -e "${GREEN}Configuring ProxyNode Node${CLEAR}"
sudo mkdir /home/proxynode0/.proxynode
sudo touch /home/proxynode0/.proxynode/prx.conf
echo "rpcuser=user"`shuf -i 100000-9999999 -n 1` >> /home/proxynode0/.proxynode/prx.conf
echo "rpcpassword=pass"`shuf -i 100000-9999999 -n 1` >> /home/proxynode0/.proxynode/prx.conf
echo "rpcallowip=127.0.0.1" >> /home/proxynode0/.proxynode/prx.conf
echo "server=1" >> /home/proxynode0/.proxynode/prx.conf
echo "daemon=1" >> /home/proxynode0/.proxynode/prx.conf
echo "maxconnections=250" >> /home/proxynode0/.proxynode/prx.conf
echo "masternode=1" >> /home/proxynode0/.proxynode/prx.conf
echo "rpcport=12195" >> /home/proxynode0/.proxynode/prx.conf
echo "listen=0" >> /home/proxynode0/.proxynode/prx.conf
echo "externalip=$(hostname -I | cut -f1 -d' '):12195" >> /home/proxynode0/.proxynode/prx.conf
echo "masternodeprivkey=$MNKEY" >> /home/proxynode0/.proxynode/prx.conf
echo "addnode=23.94.102.195" >> /home/proxynode0/.proxynode/prx.conf
echo "addnode=108.61.75.117" >> /home/proxynode0/.proxynode/prx.conf
echo "addnode=178.32.121.122" >> /home/proxynode0/.proxynode/prx.conf
echo "addnode=207.148.85.235" >> /home/proxynode0/.proxynode/prx.conf
echo "addnode=192.99.59.104" >> /home/proxynode0/.proxynode/prx.conf
echo "addnode=45.32.14.151" >> /home/proxynode0/.proxynode/prx.conf
MN1=0
if [[ $NULLREC = "y" ]] ; then
...
echo -e ${YELLOW}"Found /home/proxynode0/.proxynode/prx.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Configuration there"${CLEAR}
fi
echo
echo -e ${YELLOW}"Launching PRX Node"${CLEAR}
prxd -datadir=/home/proxynode0/.proxynode -daemon
echo
...
until prx-cli -datadir=/home/proxynode0/.proxynode mnsync status | grep -m 1 'IsBlockchainSynced" : true'; do
prx-cli -datadir=/home/proxynode0/.proxynode getblockcount
sleep 60
done
...
echo -e "${YELLOW} prx-cli -datadir=/home/proxynode0/.proxynode masternode status"${CLEAR}
echo -e "${YELLOW}For mn1: \"prx-cli -datadir=/home/proxynode0/.proxynode masternode status\""${CLEAR}
echo
